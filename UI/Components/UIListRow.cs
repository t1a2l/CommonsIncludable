...
namespace TransportLinesManager.Commons.UI.Components
{
    public abstract class UIListRow : UIPanel
    {
        ...
        public override void Awake()
        {
            ...
            _background.atlas = TextureAtlasUtils.DefaultTextureAtlas;
        }
        ...
        protected UILabel AddLabel(float xPos, float width, float textScale = 0.8f, bool wordWrap = false)
        {
            ...
            newLabel.font = Resources.FindObjectsOfTypeAll<UIFont>().FirstOrDefault((UIFont f) => f.name == "OpenSans-Regular");
