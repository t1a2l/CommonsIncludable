    ...
    public class UIList : UIComponent
    {
        ...
        public float RowHeight
        {
            ...
            set
            {
                ...
                if (value < 1)
                {
                    LogUtils.DoErrorLog("invalid height ", value, " passed to UIList.RowHeight");
                    return;
                }
        ...
        public int SelectedIndex
        {
            ...
            set
            {
                ...
                {
                    LogUtils.DoErrorLog("invalid position ", value, " passed to UIList.SelectedIndex");
                    return;
                }
        ...
        private void Setup(float rowHeight)
        {
            ...
            _contentPanel.atlas = TextureAtlasUtils.DefaultTextureAtlas;
